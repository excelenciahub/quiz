        				...
        				<div class="box box-info">
        					<div class="box-header with-border">
								...
								<div class="pull-right">
									...
									<br>
<br>
									<a href="<?php echo SITE_URL; ?>retake.php?t=<?php echo $tid; ?>&act=retake&opt=1" class="btn btn-primary btn-sm"><i class="fa fa-rotate-left"></i> Retake +</a>
								</div>
        					</div>
                                                    ...
                                                    <td>
                                                        <?php
                                                            if(in_array($answers[$val['id']],$cna)){
                                                                ...
                                                                <?php
																$_SESSION['answered'][$val['id']] = $val['id'];
                                                            }
                                                            else{
                                                                $wrong++;
                                                                ?>
